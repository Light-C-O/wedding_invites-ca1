<button class="text-base inline-flex items-center bg-[#dfcdca] hover:bg-gray-100 text-black uppercase tracking-widest font-bold py-2 px-4 border-b-4 border-[#987e82] hover:border-gray-500 hover:text-gray-900 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150" >
    {{ $slot }}
</button>
