    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex text-gray-900 font-semibold justify-between uppercase dark:text-gray-100 mb-2 " >
                ...
                <a href="{{ route('guests.index') }}" class="inline-block border-2 border-gray-100 dark:border-gray-300 px-2 py-1 rounded bg-gray-100 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600">Back to Guests</a>
