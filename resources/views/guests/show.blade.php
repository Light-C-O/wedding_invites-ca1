    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class=" bg-[#adb2a5] dark:bg-[#6a6e63] overflow-hidden shadow-sm sm:rounded-lg">
                <!-- Back to see all guests -->
                <div class="p-6 pb-2 text-grey-900 dark:text-gray-100">
                    <div class="flex justify-between font-semibold mb-4">
                        <h3 class="text-lg content-center">Guest Details:</h3>
                        <!-- Back to guests index button -->
                        <a href="{{ route('guests.index') }}" class="inline-block border border-2 border-gray-100 dark:border-gray-300 px-2 py-1 rounded bg-gray-100 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 uppercase">All Guests</a>
                    </div>
                </div>
