<nav x-data="{ open: false }" class="bg-white dark:bg-[#7c7467] border-b border-gray-100">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20 sm:h-20">
            <!-- Left spacer -->
            <div class="w-10 md:flex-1">
                <!-- Dark Mode Toggle Button -->
                <button class="me-4 dark:text-white text-dark p-2 border-gray-900 dark:border-gray-100 border-2 rounded-xl hover:bg-yellow-300 dark:hover:text-gray-800 dark:hover:border-gray-800" id='dark_toggle'>
            ...
            <div class="flex justify-center items-center md:flex-1 ">
                <a href="{{ route('dashboard') }}">
                    <x-application-logo class="block h-20 sm:h-20 w-auto fill-current text-gray-800" />
                </a>
            </div>
            

            <!-- Right container -->
            <div class="flex justify-end items-center w-10 md:flex-1">
                <!-- Settings Dropdown -->
